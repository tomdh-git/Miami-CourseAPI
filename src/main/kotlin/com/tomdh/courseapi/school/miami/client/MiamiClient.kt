...
class MiamiClient(private val webClient: WebClient, private val config: MiamiConfig) {
    ...
    private suspend fun getPostResponse(formBody: String): ResponseEntity<String> {
        if (isBusy.get()) {
            throw com.tomdh.courseapi.exceptions.ServerBusyException("Server is busy, please try again later")
        }
        ...
        return try {
            ...
            throw com.tomdh.courseapi.exceptions.ServerBusyException("Request timed out. Please try again later.")
